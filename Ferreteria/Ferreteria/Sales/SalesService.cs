    ...
    public partial class SalesService : Form
    {
        ...
        private void btnCotizar_Click(object sender, EventArgs e)
        {
            if (dgvBuyData.Rows.Count > 0 && (cmbClients.SelectedItem != null))
            {
                ...
                {
                    sbo.createSale(lblFactura.Text, Convert.ToInt32(cmbClients.SelectedItem.ToString().Split('-')[0].Trim()), Convert.ToInt32(row.Cells[0].Value), Convert.ToInt32(row.Cells[3].Value), "Service", 0);
